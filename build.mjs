...
<style>
  ...
  *:focus-visible { outline: 2px solid #798A97; outline-offset: 2px; }
  ...
  @media print {
    ...
    /* page-break-inside: avoid SOLO su section/article (era anche
       su ogni div → grafici alti venivano ritagliati invece di
       passare a pagina nuova). break-inside è la versione moderna. */
    ...
    /* Canvas chart: deve scalare alla larghezza pagina e non superare
       la pagina in altezza, altrimenti si vede tagliato. */
    canvas {
